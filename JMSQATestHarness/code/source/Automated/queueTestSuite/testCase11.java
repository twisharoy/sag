...
// -----( CREATED: 2007-08-27 17:05:07 IST
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send and wait for 1 message to/from Queue7 using no destination (i.e. It will use the Temp Queue)
		 */
		
		String testName            = "TestCase11";
		String description         = "Basic Queue / Request Reply";
		int count                  = 1;
		int timeout                = 3000;
		String[] triggerNames      = new String[] {"Automated.queueTestSuite.testCase11:triggerTest11"};
		String connectionAliasName = "BrokerA_NT_Q"; //tx mode: none
		String destinationName     = "Queue4"; //Shared State: true; Shared State Ordering: none
