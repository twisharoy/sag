...
// -----( CREATED: 2007-06-02 21:03:33 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 5 messages to Queue using Serial Trigger - Object Message Type
		 */
		 
		String testName            = "TestCase2"; 
		String description         = "Basic Queue test.";
		String[] triggerNames      = new String[] {"Automated.queueTestSuite.testCase02:triggerTest02"};
