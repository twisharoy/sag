...
// -----( CREATED: 2007-06-02 21:06:02 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 10 messages to Queue using a Message Selectors
		 *
		...
		String description         = "Basic Queue / Message Selectors test";
		String[] triggerNames      = new String[] {"Automated.queueTestSuite.testCase08:triggerTest08a", "Automated.queueTestSuite.testCase08:triggerTest08b"};
		String connectionAliasName = "BrokerA_NT_Q"; //tx mode: none
		String destinationName     = "Queue6"; //Shared State: true; Shared State Ordering: none
		int count                  = 10;
		int timeout                = 3000;
