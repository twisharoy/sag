...
// -----( CREATED: 2007-06-02 21:03:51 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 5 messages to Queue using Serial Trigger - Byte Message Type
		 */
		 
		String testName            = "TestCase3"; 
		String description         = "Basic Queue test.";
		String[] triggerNames      = new String[] {"Automated.queueTestSuite.testCase03:triggerTest03"};
