...
// -----( CREATED: 2007-06-02 22:52:57 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		String description         = "Batch Test";
		String[] triggerNames      = new String[] {"Automated.queueTestSuite.testCase12:triggerTest12"};
		String connectionAliasName = "BrokerA_Native_NT_Q"; //tx mode: none
		String destinationName     = "Queue7"; //Shared State: true; Shared State Ordering: none]
		int count                  = 1;
		String repeat              = "5";
		int timeout                = 3000;
