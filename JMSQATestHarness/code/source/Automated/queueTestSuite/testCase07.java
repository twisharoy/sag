...
// -----( CREATED: 2007-06-02 22:01:03 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send message to Queue6 and Queue7 using Serial Trigger w/ AND Join
		 */
		
		String testName            = "TestCase7";
		String description         = "Basic Queue / Join test";
		String[] triggerNames      = new String[] {"Automated.queueTestSuite.testCase07:triggerTest07"};
