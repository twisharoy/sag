...
// -----( CREATED: 2007-06-03 15:27:09 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 10 messages to Topic using Concurrent Trigger
		 */
		 
		String testName            = "ConcurrentTopicTestCase1";
		String description         = "Concurrent Topic Basic Test";
		String[] triggerNames      = new String[] {"Automated.concurrentTestSuite.testCase2:concurrentTriggerTest2"};
