...
// -----( CREATED: 2007-06-02 23:45:49 IST
// -----( ON-HOST: CPAI-D620
...
public final class testCase03

{
	// ---( internal utility methods )---

	final static testCase03 _instance = new testCase03();

	static testCase03 _newInstance() { return new testCase03(); }

	static testCase03 _cast(Object o) { return (testCase03)o; }
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 5 messages to Topic using Serial Trigger - Byte Message Type
		 */
		 
		String testName            = "TestCase3"; 
		String description         = "Basic Topic Test - Byte Message";
		String[] triggerNames      = new String[] {"Automated.topicTestSuite.testCase03:triggerTest03"};
