...
// -----( CREATED: 2007-06-02 23:52:56 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send message to Topic6 and Topic7 using Serial Trigger w/ XOR Join
		 */
		
		String testName            = "TestCase6";
		String description         = "Basic Topic XOR Join Test";
		String[] triggerNames      = new String[] {"Automated.topicTestSuite.testCase06:triggerTest06"};
