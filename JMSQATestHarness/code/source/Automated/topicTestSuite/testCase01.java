...
// -----( CREATED: 2007-06-02 23:43:19 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 10 messages to Topic1 using Serial JMS Trigger - String Message Type
		 */
		 
		String testName            = "TestCase1"; 
		String description         = "Basic Topic Test - String Message";
		String[] triggerNames      = new String[] {"Automated.topicTestSuite.testCase01:triggerTest01"};
