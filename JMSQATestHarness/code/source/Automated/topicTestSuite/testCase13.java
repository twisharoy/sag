...
// -----( CREATED: 2007-06-03 00:23:13 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		String description         = "Send/Rec via Public Service [SHOULD FAIL] - Topics";
		String connectionAliasName = "BrokerA_NT_T";
		String destinationName     = "Topic7"; //Shared State: true; Shared State Ordering: none]
		int count                  = 1;
		int timeout                = 3000;
