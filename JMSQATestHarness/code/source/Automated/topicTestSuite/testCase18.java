...
// -----( CREATED: 2007-06-03 11:27:25 IST
// -----( ON-HOST: CPAI-D620
...
public final class testCase18

{
	// ---( internal utility methods )---

	final static testCase18 _instance = new testCase18();

	static testCase18 _newInstance() { return new testCase18(); }

	static testCase18 _cast(Object o) { return (testCase18)o; }
        ...
        throws ServiceException
	{
		...
		/*
		 * Send & Receciving Message stream Public Service - Text File
		 * We are using Durable Subscriber to receive the message
		 */
		 
		String testName            = "TestCase18"; 
		String description         = "Large Message Stream - Topic Test";
