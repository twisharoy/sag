...
// -----( CREATED: 2007-06-03 10:50:17 IST
// -----( ON-HOST: CPAI-D620
...
public final class testCase16

{
	// ---( internal utility methods )---

	final static testCase16 _instance = new testCase16();

	static testCase16 _newInstance() { return new testCase16(); }

	static testCase16 _cast(Object o) { return (testCase16)o; }
        ...
        throws ServiceException
	{
		 ...
		 * When we set Ignore Locally Published Flag to false, The trigger should 
		 * be able to receive the message
		 */
		 
		String testName            = "TestCase16"; 
		String description         = "Using Durable Subscriber & isNoLocal = False for Topics [SHOULD PASS]";
