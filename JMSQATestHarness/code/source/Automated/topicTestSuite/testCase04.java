...
// -----( CREATED: 2007-06-02 23:47:18 IST
// -----( ON-HOST: CPAI-D620
...

{
        ...
        throws ServiceException
	{
		...
		/*
		 * Send 5 messages to Topic using Serial Trigger - IDOC Message Type
		 */
		 
		String testName            = "TestCase4"; 
		String description         = "Basic Topic Test - IDOC Message";
		String[] triggerNames      = new String[] {"Automated.topicTestSuite.testCase04:triggerTest04"};
		String connectionAliasName = "BrokerA_Native_NT_T";
