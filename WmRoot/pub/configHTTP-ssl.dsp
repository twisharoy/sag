...
%comment% --- Trax 1-1-YN64D Add support for Keystores (HSM and file based) --- %endcomment%
          ...
          <tr>
              ...
              <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
                <script>writeEdit('%value mode%', 'keyStoreLocation', '%value -code keyStoreLocation%');</script>
              </td>
          </tr>
          ...
          <tr>
              ...
              <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
                <script>writeEditPass('%value mode%', 'password', '%value -code password%');</script>
              </td>
          </tr>
		  %endif%
	  <tr>
              ...
              <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
%comment%                <script>writeEdit('%value mode%', 'keyStoreType', '%value -code keyStoreType%');</script> %endcomment%
                %ifvar ../mode equals('view')%
          ...
          <tr>
              ...
              <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
                <script>writeEdit('%value mode%', 'alias', '%value -code alias%');</script>
              </td>
          </tr>
	%ifvar listenerKey equals('')%
			  <tr>
	              <td class="evenrow">Trusted Authority Directory</td>
	              <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
	                <script>writeEdit('%value mode%', 'keyStoreCADir', '%value -code keyStoreCADir%');</script>
	              </td>
	          </tr>
	%else%
			  <tr>
