  ...
  <head>
    ...
    <script language="JavaScript">
  	...
  	function validate(theForm)
  	{
  		...
  		var js_maxElementsOnDisk = theForm.maxElementsOnDisk;
  		if(!isValidInteger(js_maxElementsOnDisk,"'Maximum Elements on Disk'" , false ,false))
  		{
  			return false;
  		}
  	...
  	function enableDisableClstredFields(isInternal)
  	{
  		...
  		else
  		{
  			...
  			js_timeoutMillis.readOnly = false;  js_timeoutMillis.style.color = '#000000';
  			js_enabled.checked = true;
  		}
  	...
  	function populateInitialValues()
  	{
  		...
  		var js_maxElementsOnDisk = document.getElementById('maxElementsOnDisk');
  		gOldMaxElOnDiskVal = js_maxElementsOnDisk.value;
  	...
  	function enableDisableDiskFields(isInternal , flag)
  	{
  		...
  		if(!isInternal || 'false' == isInternal)
  		{
  			if(js_clustered.checked)
  			{
  				js_maxElementsOnDisk.readOnly = false;
  				js_maxElementsOnDisk.style.color = '#000000';
  				js_maxElementsOnDisk.value = gOldMaxElOnDiskVal;
  			...
  			else
  			{
  				...
  				{
  					js_maxElementsOnDisk.readOnly = true;
  					js_maxElementsOnDisk.style.color = '#808080';
  					if('true' != flag)
  					{
  						gOldMaxElOnDiskVal = js_maxElementsOnDisk.value;
  						gOldDiskExpThIntervalVal = js_diskExpiryThreadIntervalSeconds.value;
  					...
  					<tr>
  						...
  						<td valign="top" width="50%">	
  							<table class="tableForm" width="100%">
  								...
  								<tr>
  									<td class="evenrow">Maximum Elements on Disk</td>	
  									<td class="evenrow-l">
  										%ifvar operation equals('add')%
  											<input type="text" name="maxElementsOnDisk" id="maxElementsOnDisk" value="0">
  										%endif%	
  										%ifvar operation equals('edit')%
  											<input type="text" name="maxElementsOnDisk" id="maxElementsOnDisk" value="%value maxElementsOnDisk%">
  										%endif%
  									</td>
  								</tr>
  								...
  								<tr>
  									<td class="oddrow">Statistics</td>	
  									<td class="oddrow-l">
  									%ifvar operation equals('add')%
  										<input type="checkbox" name="statistics" id="statistics">
  									%endif%	
  									%ifvar operation equals('edit')%
  										<input type="checkbox" name="statistics" id="statistics" %ifvar statistics equals('true')%checked%endif% %ifvar isInternal equals('true')%disabled="disabled"%endif%>
  									%endif%
  									</td>
  								</tr>
  								<tr>
  									<td class="evenrow">Logging</td>	
  									<td class="evenrow-l">
  									%ifvar operation equals('add')%	
  								...
  								<tr>
  									<td class="oddrow" width="50%">Overflow to Off-heap</td>	
  									<td class="oddrow-l" width="50%">
  									%ifvar operation equals('add')%	
  								...
  								<tr>
  									<td class="evenrow">Maximum Off-heap</td>	
  									<td class="evenrow-l">
  										%ifvar operation equals('add')%
  						...
  						<td valign="top">
  							<table class="tableForm" width="100%" >
  								...
  								<tr>
  									<td class="oddrow" width="50%">Enable High Availability</td>
  									<td class="oddrow-l">
  									%ifvar operation equals('add')%
  								...
  								<tr>
  									<td class="oddrow" width="50%">Timeout Behavior</td>	
  									<td class="oddrow-l" width="50%">
  										%ifvar operation equals('add')%
  								...
  								<tr>
  									<td class="evenrow">Immediate Timeout When Disconnected</td>	
  									<td class="evenrow-l">
  									%ifvar operation equals('add')%
  								...
  								<tr>
  									<td class="oddrow">Synchronous Writes</td>	
  									<td class="oddrow-l">
  									%ifvar operation equals('add')%
  								...
  								%ifvar licenseDetails/isDistributedCacheLicensed equals('false')%
  									<tr><td class="evenrow-l" colspan=2><font color='#808080'><b>Distributed license required for distributed cache configuration.</b></font></td></tr>
  								%else%
  									%ifvar licenseDetails/isTSAConfigured equals('false')%
  										<tr><td class="evenrow-l" colspan=2><font color='#808080'><b>Distributed cache can be created when the cache manager is configured to connect to Terracotta Server Array.</b></font></td></tr>
  									%endif%
  								%endif%	
