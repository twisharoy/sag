            ...
            <TD>
               <TABLE class="tableForm" CELLPADDING=2> %ifvar interface%
                %invoke wm.server.xidl.adminui:testService%
                  <FORM name="testform" method="get" action="/invoke/%value -urlencode interface%/%value -urlencode service%">
                     <TR>
                     ...
                     <TR>
                        ...
                        %switch field_type%
                            ...
                            <INPUT name="%value field_name%" value=""></TD>
                            ...
                            <script>writeTD("row-l");swapRows();</script>
                                ...
                                %value field_name% &nbsp;&nbsp;</TD>
                                <script>writeTD("row-l");</script>
                                <INPUT name="%value field_name%" value="" >
                                </TD>
                                </TR>
                                %endloop%
                                </TABLE>
