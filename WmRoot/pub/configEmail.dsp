      ...
      <tr>
		...
		%endif%
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value -htmlcode mode%', 'host', '%value host%');</script>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value -htmlcode mode%', 'server_port', '%value -code server_port%');</script>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value -htmlcode mode%', 'user', '%value -code user%');</script>
            </td>
          </tr>
          <tr>
	  ...
	  <tr>
		...
		<td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value -htmlcode mode%', 'interval', '%value interval%');</script>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value -htmlcode mode%', 'gservice', '%value gservice%');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">Default Service (optional)</td>
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
            <script>writeEdit('%value -htmlcode mode%', 'dservice', '%value dservice%');</script>
            </td>
          </tr>
          <tr>
