...
<META HTTP-EQUIV="Expires" CONTENT="-1">
  ...
  <BODY onLoad="loadKeyStoresOptions(); toggleSSL('%value ssl%'); setNavigation('settings-remote.dsp', '/WmRoot/doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_EditRemoteSvrAliasScrn');">
  %else%
  <BODY onLoad="loadKeyStoresOptions(); toggleSSL('%value ssl%'); setNavigation('settings-remote.dsp', '/WmRoot/doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_CreateRemoteSvrAliasScrn');">
  %endif%
    <TABLE width="100%">
      <TR>
