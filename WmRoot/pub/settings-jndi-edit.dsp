...
<head>
  ...
  <script language ="javascript">
    ...
    function saveCurrent() {
      ...
      jndiContext = '%value none initialContextFactory%';
                            
      jndiUrl = '%value none providerURL%';
      jndiPrincipal = '%value none securityPrincipal%';
      jndiCredentials = '%value none securityCredentials%';
      jndiOther = '%value none otherProps%';
    }
