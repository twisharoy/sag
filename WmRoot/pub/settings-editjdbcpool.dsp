      ...
      <TD>
        ...
        %endif%
          <TR>
            ...
            %ifvar funct equals(Add)%
            	%ifvar test equals(completed)%
            		<INPUT NAME="pool" TYPE="TEXT" VALUE="%value encode(htmlattr) pool%" SIZE="60">
            	%else%
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
              		<INPUT NAME="description" TYPE="TEXT" VALUE="%value encode(htmlattr) description%" SIZE="60">
              	%else%
                	<INPUT NAME="description" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.description%" SIZE="60">
                %endif%
              %endif%
            </TD>
          </TR>
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
              		<TEXTAREA NAME="url" TYPE="TEXT" VALUE="%value encode(htmlattr) url%" cols="60" rows="1"></TEXTAREA>
              	%else%
                	<TEXTAREA NAME="url" TYPE="TEXT" VALUE="%value encode(htmlattr) url%" cols="60" rows="1"></TEXTAREA>
                %endif%
              %endif%
          ...
          %ifvar test equals(completed)%
          	<SCRIPT>setDatabaseUrl("%value url%");</SCRIPT>
          %else%
          	<SCRIPT>setDatabaseUrl("%value pool.url%");</SCRIPT>
          %endif%
          <SCRIPT>swapRows();</SCRIPT>
			%ifvar funct equals(Display)%
			%else%
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
                	<INPUT NAME="uid" TYPE="TEXT" VALUE="%value encode(htmlattr) uid%" SIZE="12">
                %else%
                	<INPUT NAME="uid" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.uid%" SIZE="12">
                %endif%
              %endif%
            </TD>
          </TR>
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
                	<INPUT NAME="mincon" TYPE="TEXT" VALUE="%value encode(htmlattr) mincon%" SIZE="10">
                %else%
                	<INPUT NAME="mincon" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.mincon%" SIZE="10">
                %endif%
              %endif%
            </TD>
          </TR>
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
                	<INPUT NAME="maxcon" TYPE="TEXT" VALUE="%value encode(htmlattr) maxcon%" SIZE="10">
                %else%
                	<INPUT NAME="maxcon" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.maxcon%" SIZE="10">
                %endif%
              %endif%
            </TD>
          </TR>
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
                	<INPUT NAME="poolThreshold" TYPE="TEXT" VALUE="%value encode(htmlattr) poolThreshold%" SIZE="10">
                %else%
                	<INPUT NAME="poolThreshold" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.poolThreshold%" SIZE="10">
                %endif%
              %endif%
            %
            </TD>
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
                	<INPUT NAME="waitingThread" TYPE="TEXT" VALUE="%value encode(htmlattr) waitingThread%" SIZE="10">
                %else%
                	<INPUT NAME="waitingThread" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.waitingThread%" SIZE="10">
                %endif%
              %endif%
            </TD>
          </TR>
          ...
          <TR>
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
              	%ifvar test equals(completed)%
                	<INPUT NAME="idle" TYPE="TEXT" VALUE="%value encode(htmlattr) idle%" SIZE="10"> milliseconds 
                %else%
                	<INPUT NAME="idle" TYPE="TEXT" VALUE="%value encode(htmlattr) pool.idle%" SIZE="10"> milliseconds 
                %endif%
              %endif%
            </TD>
          </TR>
