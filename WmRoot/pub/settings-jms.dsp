              ...
              <script>writeTD("rowdata");</script>
                ...
                %else%
                 %ifvar hasTriggers equals('true')%
                  ...
                  %else%
                    <a href="settings-jms.dsp?action=delete&aliasName=%value aliasName encode(url)%" onClick="javascript:return confirm('Are you sure you want to delete Connection Alias %value aliasName%?')">
                      <img style="width: 13px; height: 13px;" alt="active" border="0" src="icons/delete.gif">
                    </a>
                  %endif%
                %endif%
