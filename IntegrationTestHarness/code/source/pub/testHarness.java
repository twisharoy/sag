...
// -----( CREATED: 2007-06-02 21:55:42 IST
// -----( ON-HOST: CPAI-D620
...

{
	...
	final static testHarness _instance = new testHarness();

	static testHarness _newInstance() { return new testHarness(); }

	static testHarness _cast(Object o) { return (testHarness)o; }
