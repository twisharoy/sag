      ...
      <TR>
        ...
        <TD>
          <TABLE class="tableForm">
            ...
            <form name="properties" method="post" action="/WmRoot/security-ports.dsp" onsubmit="return verify('%value encode(htmlattr) listenerKey%');">
        ...
        <tr><td class="heading" colspan=2>Polling Information</td></tr>
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'monitorDir', '%value -code monitorDir%');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">Working Directory (optional)</td>
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value mode%', 'workDir', '%value -code workDir%');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">Completion Directory (optional)</td>
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'completionDir', '%value -code completionDir%');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">Error Directory (optional)</td>
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value mode%', 'errorDir', '%value -code errorDir%');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">File Name Filter (optional)</td>
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'fileNameFilter', '%value encode(htmlattr) fileNameFilter%');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">File Age (optional) (seconds)</td>
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value mode%', 'fileAge', '%value -code fileAge%');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">Content Type (optional)</td>
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'defaultContentType', '%value -code defaultContentType%');</script>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value mode%', 'lockFileExtension', '%value -code lockFileExtension%');</script>
            </td>
          </tr>
          <tr>
			<td class="oddrow">Number of files to process per Interval (optional)</td>
			<td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
			  <script>writeEdit('%value mode%', 'maxFilesPerCycle', '%value -code maxFilesPerCycle%');</script>
			</td>
          </tr>
          </table>
          </td>
	 	...
	 	<SCRIPT>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'processingService', '%value -code processingService%');</script>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value mode%', 'filePollingInterval', '%value filePollingInterval%');</script>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'cleanUpService', '%value cleanUpService%');</script>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'cleanUpFileAge', '%value cleanUpFileAge%');</script>
            </td>
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>writeEdit('%value mode%', 'cleanUpInterval', '%value cleanUpInterval%');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">Maximum Number of Invocation Threads</td>
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>writeEdit('%value mode%', 'maxThreads', '%value maxThreads%');</script>
            </td>
          </tr>
          ...
          <tr>
            ...
            <input type="button" value="Save Changes" onclick="verify('%value encode(htmlattr) listenerKey%');">
            </td>
          </tr>
          %endif%
          </form>
